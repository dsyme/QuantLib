...
To date, 107~theorems have been fully machine-checked across eight verification targets,
with only 4~remaining proof obligations (3~requiring Float axioms and
...
exact rationals. All fifteen theorems are fully proved: interval
...
production quantitative finance library.  Over one hundred theorems have
...
yield curve bootstrapping and floating-point comparison utilities.
