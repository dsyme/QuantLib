...
conventions (Actual/360 and 30/360), interest rate compounding algebra, and linear
interpolation---as pure functional definitions over exact arithmetic and prove key
algebraic properties including additivity, round-trip inversion, monotonicity,
rate composition, and identity laws.
To date, 54~theorems have been fully machine-checked across four verification targets
(Actual360, InterestRate, Thirty360, LinearInterpolation), with only 3~remaining
proof obligations that require Float-level transcendental function axioms not
available in Lean's standard library.
Correspondence between the Lean models and the C++ source is validated through
automated executable testing (2,920~test cases for Actual360 and 12 for
LinearInterpolation).
...
\begin{enumerate}
  ...
  \item Prove 54~theorems fully and identify 3~proof obligations
...
${\sim}65$ lines.  The InterestRate specification is 31~theorem
...
\paragraph{Scope.}
Four of QuantLib's many components have been verified.
The remaining candidate (NormalDistribution) is identified but not yet formalised
due to the difficulty of reasoning about transcendental functions.
...
production quantitative finance library.  Fifty-four theorems have
been proved across four targets, covering fundamental algebraic
properties of day counting and interest rate compounding.
Correspondence testing with ${\sim}2{,}930$ cases validates
...
proofs (requiring Float axioms), extending verification to
NormalDistribution, and deepening correspondence validation
across all targets.
